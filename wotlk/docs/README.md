...
| Папка/Файл | Описание |
|------------|----------|
| **reference/offsets.txt** | Оффсеты функций для билда 12340 |
| **plans/bypass_lua.txt** | Заметки про обход Lua-проверок |
| **plans/warden_bypass_plan.md** | План обхода Warden (оригинальный документ) |
